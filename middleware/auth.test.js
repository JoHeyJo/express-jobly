...
describe("ensureCurrentUserOrAdmin", function () {
  test("works if curr user and not admin", function () {
    expect.assertions(1);
  ...
  test("works if admin and not curr user", function () {
    expect.assertions(1);
  ...
  test("fails if not logged in", function () {
    expect.assertions(1);
    const req = { params: { username: "test2" } };
    const res = { locals: {} };
    const next = function (err) {
  ...
  test("fails if not current user and not admin", function () {
    expect.assertions(1);
    const req = { params: { username: "test2" } };
    const res = { locals: { user: { username: "test", isAdmin: false } } };
    const next = function (err) {
