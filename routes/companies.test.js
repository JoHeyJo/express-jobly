...
/************************************** GET /companies?queryfilters */

describe("GET /companies? with query filters", function () {
  test("ok with minEmployees", async function () {
  ...
  test("ok with maxEmployees", async function () {
  ...
  test("ok with minEmployees and maxEmployees", async function () {
  ...
  test("ok with nameLike", async function () {
  ...
  test("ok with all three parameters", async function () {
    const resp = await request(app).get("/companies?minEmployees=1&maxEmployees=3&nameLike=c");
    expect(resp.body).toEqual({
      companies:
        [
          {
